...
module.exports = "<form [formGroup]=\"form\" (ngSubmit)=\"onSubmit(form.value)\">\r\n  <div class=\"example-container\">\r\n    <mat-grid-list cols=\"2\" rowHeight=\"70px\" gutterSize=\"20px\">\r\n      <mat-grid-tile>\r\n        <mat-form-field>\r\n          <mat-label>Pick Date</mat-label>\r\n          <input matInput [matDatepicker]=\"startDate\" placeholder=\"Choose a date\" formControlName=\"startDate\">\r\n          <mat-datepicker-toggle matSuffix [for]=\"startDate\"></mat-datepicker-toggle>\r\n          <mat-datepicker #startDate></mat-datepicker>\r\n          <mat-error *ngIf=\"form.get('startDate').invalid\">{{getErrorMessage()}}</mat-error>\r\n        </mat-form-field>\r\n      </mat-grid-tile>\r\n      <mat-grid-tile>\r\n        <mat-form-field>\r\n          <mat-label>Delivery Date</mat-label>\r\n          <input matInput [matDatepicker]=\"endDate\" placeholder=\"Choose a date\" formControlName=\"endDate\">\r\n          <mat-datepicker-toggle matSuffix [for]=\"endDate\"></mat-datepicker-toggle>\r\n          <mat-datepicker #endDate></mat-datepicker>\r\n          <mat-error *ngIf=\"form.get('endDate').invalid\">{{getErrorMessage()}}</mat-error>\r\n        </mat-form-field>\r\n      </mat-grid-tile>\r\n      <mat-grid-tile>\r\n        <mat-form-field>\r\n          <mat-label>Truck Plate Number</mat-label>\r\n          <input matInput placeholder=\"Truck Plate Number\" formControlName=\"truck\">\r\n          <mat-error *ngIf=\"form.get('truck').invalid\">{{getErrorMessage()}}</mat-error>\r\n        </mat-form-field>\r\n      </mat-grid-tile>\r\n    </mat-grid-list>\r\n  </div>\r\n  <div class=\"button-row\">\r\n    <button mat-raised-button color=\"primary\" type=\"submit\">Submit</button>\r\n    <button mat-raised-button color=\"warn\" [routerLink]=\"['/home/products','driver']\">Cancel</button>\r\n  </div>\r\n</form>"
...
var DriverComponent = /** @class */ (function () {
    function DriverComponent(service, route, router, fb) {
        var _this = this;
        this.service = service;
        this.route = route;
        this.router = router;
        ...
        this.form = fb.group({
            ...
            truck: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required]
        });
    }
...
var AddProductComponent = /** @class */ (function () {
    function AddProductComponent(service, route, authService, router, fb, dialog, authSevice) {
        this.service = service;
        this.route = route;
...
var BottlerAuthGuard = /** @class */ (function (_super) {
    ...
    BottlerAuthGuard.prototype.canActivate = function () {
        ...
        if (this.authService.currentUser.role === __WEBPACK_IMPORTED_MODULE_3__shared_Roles_enum__["a" /* Roles */].Bottler) {
            return true;
        }
        this.router.navigate(['/no-access']);
        return false;
...
var DriverAuthGuard = /** @class */ (function (_super) {
    ...
    DriverAuthGuard.prototype.canActivate = function () {
        ...
        if (this.authService.currentUser.role === __WEBPACK_IMPORTED_MODULE_3__shared_Roles_enum__["a" /* Roles */].Distributor) {
            return true;
        }
        this.router.navigate(['/no-access']);
        return false;
...
var GrowerAuthGuard = /** @class */ (function (_super) {
    ...
    GrowerAuthGuard.prototype.canActivate = function () {
        ...
        if (this.authService.currentUser.role === __WEBPACK_IMPORTED_MODULE_3__shared_Roles_enum__["a" /* Roles */].Grower) {
            return true;
        }
        this.router.navigate(['/no-access']);
        return false;
...
var WineryAuthGuard = /** @class */ (function (_super) {
    ...
    WineryAuthGuard.prototype.canActivate = function () {
        ...
        if (this.authService.currentUser.role === __WEBPACK_IMPORTED_MODULE_3__shared_Roles_enum__["a" /* Roles */].Winery) {
            return true;
        }
        this.router.navigate(['/no-access']);
        return false;
...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.isGrower = function () {
        return this.role === __WEBPACK_IMPORTED_MODULE_5__shared_Roles_enum__["a" /* Roles */].Grower;
    };
    MainComponent.prototype.isWinery = function () {
        return this.role === __WEBPACK_IMPORTED_MODULE_5__shared_Roles_enum__["a" /* Roles */].Winery;
    };
    MainComponent.prototype.isBottler = function () {
        return this.role === __WEBPACK_IMPORTED_MODULE_5__shared_Roles_enum__["a" /* Roles */].Bottler;
    };
    MainComponent.prototype.isDriver1 = function () {
        return this.role === __WEBPACK_IMPORTED_MODULE_5__shared_Roles_enum__["a" /* Roles */].Distributor;
    };
...
var ProductListComponent = /** @class */ (function () {
    ...
    ProductListComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.service.getAllProducts(_this.action === 'transaction')
                .takeUntil(_this.componentDestroyed$)
    ...
    ProductListComponent.prototype.populateWineryMetaData = function () {
        this.columns = [
            ...
            { columnDef: 'volume', header: 'Volume', cell: function (row) { return "" + (row.wineries.length && row.wineries[0].volume ? row.wineries[0].volume : ''); } }
        ];
        if (this.action !== 'transaction') {
            this.columns.push({
                columnDef: 'action',
                header: 'Action',
                cell: function (row) { return row.grapes[0].actualWeight && row.wineries.length && row.wineries[0].volume ? 'Transfer' : ''; }
            });
        }
    };
    ProductListComponent.prototype.populateBottlerMetaData = function () {
        this.columns = [
            ...
            { columnDef: 'variety', header: 'Variety', cell: function (row) { return "" + row.grapes[0].variety; } },
            { columnDef: 'vintage', header: 'Vintage', cell: function (row) { return "" + row.grapes[0].vintage; } },
            { columnDef: 'volume', header: 'Volume', cell: function (row) { return "" + row.wineries[0].volume; } },
            { columnDef: 'brand', header: 'Brand', cell: function (row) { return "" + (row.wines.length && row.wines[0].brand ? row.wines[0].brand : ''); } },
            { columnDef: 'label', header: 'Label', cell: function (row) { return "" + (row.wines.length && row.wines[0].label ? row.wines[0].label : ''); } },
            { columnDef: 'corkCap', header: 'Cork Cap', cell: function (row) { return "" + (row.wines.length && row.wines[0].corkCap ? row.wines[0].corkCap : ''); } },
            { columnDef: 'status', header: 'Status', cell: function (row) { return "" + (row.wines.length && row.wines[0].status ? row.wines[0].status : ''); } }
        ];
    };
    ...
    Object.defineProperty(ProductListComponent.prototype, "showAddButton", {
        get: function () {
            return this.authService.currentUser.role === __WEBPACK_IMPORTED_MODULE_8__shared_Roles_enum__["a" /* Roles */].Grower && this.action !== 'transaction';
        },
        enumerable: true,
        configurable: true
    });
