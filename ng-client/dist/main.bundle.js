...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_app_validators__ = __webpack_require__("./src/app/shared/app.validators.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BottlerProductComponent = /** @class */ (function () {
    function BottlerProductComponent(service, router, route, authService, fb) {
        ...
        this.statuses = ['Bulk Wine', '12 pk boxes', '6 pk boxes'];
        this.corkCaps = ['Cork', 'Cap'];
    ...
    BottlerProductComponent.prototype.ngOnInit = function () {
        ...
        this.form = this.fb.group({
            brand: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            lcode: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            label: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            corkCap: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            status: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            boxes: [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__shared_app_validators__["a" /* AppValidators */].numberSpace]]
        });
        this.form.controls.status.valueChanges
            .takeUntil(this.unsubscribe)
            .subscribe(function (newValue) {
            if (newValue === 'Bulk Wine') {
                _this.form.removeControl('boxes');
            }
            else {
                _this.form.addControl('boxes', new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* FormControl */](null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__shared_app_validators__["a" /* AppValidators */].numberSpace]));
            }
        });
    ...
    BottlerProductComponent.prototype.showBoxQuestion = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_Roles_enum__ = __webpack_require__("./src/app/shared/Roles.enum.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DriverComponent = /** @class */ (function () {
    function DriverComponent(service, route, router, authService, fb) {
        ...
        this.roles = __WEBPACK_IMPORTED_MODULE_7__shared_Roles_enum__["a" /* Roles */];
    }
    DriverComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.form = this.fb.group({
            driverId: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            plateNumber: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
        });
        this.route.params.subscribe(function (pamams) {
            _this.service.getProduct(pamams.id)
                .takeUntil(_this.componentDestroyed$)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__shared_app_validators__ = __webpack_require__("./src/app/shared/app.validators.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AddProductComponent = /** @class */ (function () {
    function AddProductComponent(service, route, router, fb, dialog, authSevice) {
        ...
        this.componentDestroyed$ = new __WEBPACK_IMPORTED_MODULE_5_rxjs_Subject__["a" /* Subject */]();
        this.companies = ['Hoggies Estate'];
        this.statuses = ['Grapes'];
        this.numberPattern = '\d+(\.\d{1,2})?';
    }
    AddProductComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.form = this.fb.group({
            companyName: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            region: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            vineyard: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            block: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            rowRange: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            variety: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            vintage: [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_10__shared_app_validators__["a" /* AppValidators */].numberSpace]],
            bins: [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_10__shared_app_validators__["a" /* AppValidators */].numberSpace]],
            status: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
            estimatedWeight: [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_10__shared_app_validators__["a" /* AppValidators */].float]]
        });
    ...
    AddProductComponent.prototype.getErrorMessage = function () {
        var e = this.form.controls.vintage.errors;
        return 'You must enter a value';
    };
...
var DriverAuthGuard = /** @class */ (function (_super) {
    ...
    DriverAuthGuard.prototype.canActivate = function () {
        ...
        if (this.authService.isAuth(__WEBPACK_IMPORTED_MODULE_3__shared_Roles_enum__["a" /* Roles */].Logistic) || this.authService.isAuth(__WEBPACK_IMPORTED_MODULE_3__shared_Roles_enum__["a" /* Roles */].Logistic2)) {
            return true;
        }
        this.router.navigate(['/no-access']);
        return false;
...
module.exports = "<h2 mat-dialog-title>Transferring...</h2>\r\n<mat-dialog-content>\r\n  <div class=\"row\">\r\n    <div class=\"col-5\">\r\n      <mat-form-field>\r\n        <input matInput [matDatepicker]=\"picker\" [min]=\"minDate\" [(ngModel)]=\"product.transferDate\" placeholder=\"Choose a transfer date\">\r\n        <mat-datepicker-toggle matSuffix [for]=\"picker\"></mat-datepicker-toggle>\r\n        <mat-datepicker #picker [startAt]=\"startDate\"></mat-datepicker>\r\n      </mat-form-field>\r\n      <br/>\r\n      <mat-form-field>\r\n        <mat-label>\r\n          <i> Transfer to </i>\r\n        </mat-label>\r\n        <mat-select [(ngModel)]=\"product.transferTo\" required>\r\n          <mat-option>-- None --</mat-option>\r\n          <mat-option *ngFor=\"let user of product.parteners\" [value]=\"user.orgnizationName\">{{ user.orgnizationName }}</mat-option>\r\n        </mat-select>\r\n      </mat-form-field>\r\n    </div>\r\n    <div class=\"col-7\">\r\n      <mat-grid-list cols=\"2\" rowHeight=\"30px\" class=\"confirm-tranfer-grid\">\r\n        <mat-grid-tile>\r\n          Company Name:\r\n        </mat-grid-tile>\r\n        <mat-grid-tile>\r\n          {{ product.companyName}}\r\n        </mat-grid-tile>\r\n        <mat-grid-tile>\r\n          Region:\r\n        </mat-grid-tile>\r\n        <mat-grid-tile>\r\n          {{ product.grapes[0].region}}\r\n        </mat-grid-tile>\r\n        <mat-grid-tile>\r\n          Variety:\r\n        </mat-grid-tile>\r\n        <mat-grid-tile>\r\n          {{ product.grapes[0].variety}}\r\n        </mat-grid-tile>\r\n        <mat-grid-tile>\r\n          Vintage:\r\n        </mat-grid-tile>\r\n        <mat-grid-tile>\r\n          {{ product.grapes[0].vintage}}\r\n        </mat-grid-tile>\r\n        <ng-container *ngIf=\"product.showWeight\">\r\n          <mat-grid-tile>\r\n            Estimate Weight:\r\n          </mat-grid-tile>\r\n          <mat-grid-tile>\r\n            {{ product.grapes[0].estimatedWeight}}\r\n          </mat-grid-tile>\r\n        </ng-container>\r\n        <ng-container *ngIf=\"product.showVolume\">\r\n          <mat-grid-tile>\r\n            Volume:\r\n          </mat-grid-tile>\r\n          <mat-grid-tile>\r\n            {{ product.wineries[0].volume}}\r\n          </mat-grid-tile>\r\n        </ng-container>\r\n      </mat-grid-list>\r\n    </div>\r\n  </div>\r\n</mat-dialog-content>\r\n<mat-dialog-actions>\r\n  <button mat-raised-button [mat-dialog-close]=\"product.transferDate\" [disabled]=\"!isValid()\" color=\"primary\">Yes</button>\r\n  <button mat-raised-button (click)=\"onNoClick()\" color=\"warn\">No</button>\r\n</mat-dialog-actions>"
...
var ConfirmDialogComponent = /** @class */ (function () {
    function ConfirmDialogComponent(dialogRef, product) {
    ...
    ConfirmDialogComponent.prototype.isValid = function () {
        return this.product.transferDate instanceof Date && this.product.transferTo !== undefined;
    };
    Object.defineProperty(ConfirmDialogComponent.prototype, "startDate", {
        get: function () {
            return new Date();
        },
        enumerable: true,
    ...
    ConfirmDialogComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_material__["h" /* MatDialogRef */],
            __WEBPACK_IMPORTED_MODULE_2__model_Product__["a" /* Product */]])
...
var ProductListComponent = /** @class */ (function () {
        ...
        this.route.params.subscribe(function () {
            ...
            _this.service.getAllProducts(_this.authService.transaction)
                ...
                setTimeout(function () {
                    ...
                    _this.dataSource = new __WEBPACK_IMPORTED_MODULE_1__angular_material__["v" /* MatTableDataSource */](_this.records);
    ...
    ProductListComponent.prototype.populateMetaData = function () {
        switch (this.authService.currentRole) {
            ...
            case __WEBPACK_IMPORTED_MODULE_9__shared_Roles_enum__["a" /* Roles */].Logistic:
                ...
                break;
            case __WEBPACK_IMPORTED_MODULE_9__shared_Roles_enum__["a" /* Roles */].Logistic2:
    ...
    ProductListComponent.prototype.populateGrowerMetaData = function () {
        ...
        this.columns = [
            ...
            { columnDef: 'bins', header: 'Number of Bins', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'bins'); } },
            { columnDef: 'status', header: 'Status', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'status'); } },
            { columnDef: 'estimatedWeight', header: 'Estimated Weight(T)', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'estimatedWeight'); } }
        ];
        if (this.authService.transaction) {
            this.columns.push({ columnDef: 'actualWeight', header: 'Actual Weight(T)', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].wineryValue(row, 'actualWeight'); } });
            this.columns.push({ columnDef: 'transferDate', header: 'Transfered Date', cell: function (row) { return "" + _this.formatedDate(__WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'transferDate')); } });
        }
        else {
    ...
    ProductListComponent.prototype.populateWineryMetaData = function () {
        ...
        this.columns = [
            ...
            { columnDef: 'vintage', header: 'Vintage', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'vintage'); } },
            { columnDef: 'estimatedWeight', header: 'Estimated Weight(T)', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'estimatedWeight'); } },
            { columnDef: 'actualWeight', header: 'Actual Weight(T)', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].wineryValue(row, 'actualWeight'); } },
            { columnDef: 'volume', header: 'Volume(L)', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].wineryValue(row, 'volume'); } },
            { columnDef: 'status', header: 'Status', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].wineryValue(row, 'status'); } }
        ];
        if (this.authService.transaction) {
            this.columns.push({ columnDef: 'transferDate', header: 'Transfered Date', cell: function (row) { return "" + _this.formatedDate(__WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].wineryValue(row, 'transferDate')); } });
        }
        else {
            this.columns.push({
                columnDef: 'action',
    ...
    ProductListComponent.prototype.populateBottlerMetaData = function () {
        ...
        this.columns = [
            ...
            { columnDef: 'lcode', header: 'L Code', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].wineValue(row, 'lcode'); } },
            ...
            { columnDef: 'boxes', header: 'Number of Boxes', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].wineValue(row, 'boxes'); } }
        ];
        if (this.authService.transaction) {
            this.columns.push({ columnDef: 'transferDate', header: 'Transfered Date', cell: function (row) { return "" + _this.formatedDate(__WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].wineValue(row, 'transferDate')); } });
        }
        else {
            this.columns.push({
                columnDef: 'action',
    ...
    ProductListComponent.prototype.populateLogistic1MetaData = function () {
        var _this = this;
        this.columns = [
            { columnDef: 'companyName', header: 'Company Name', cell: function (row) { return "" + row.companyName; } },
            { columnDef: 'variety', header: 'Variety', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'variety'); } },
            { columnDef: 'vintage', header: 'Vintage', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'vintage'); } },
            { columnDef: 'estimatedWeight', header: 'Weight', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'estimatedWeight'); } },
            { columnDef: 'driverId', header: 'Driver\'s ID', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].transportValue(row, 'driverId'); } },
        ...
        if (!this.authService.transaction) {
            ...
            this.columns.push({ columnDef: 'from', header: 'From', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'user').location; } });
            this.columns.push({ columnDef: 'to', header: 'To', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].wineryValue(row, 'user').location; } });
            this.columns.push({ columnDef: 'loadDate', header: 'Load Date', cell: function (row) { return "" + _this.formatedDate(__WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'transferDate')); } });
            this.columns.push({ columnDef: 'deliveryDate', header: 'Delivery Date', cell: function (row) { return "" + _this.formatedDate(__WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].transportValue(row, 'transferDate')); } });
        }
    };
    ProductListComponent.prototype.populateLogistic2MetaData = function () {
        var _this = this;
        this.columns = [
            { columnDef: 'companyName', header: 'Company Name', cell: function (row) { return "" + row.companyName; } },
            { columnDef: 'variety', header: 'Variety', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'variety'); } },
    ...
    ProductListComponent.prototype.formatedDate = function (date) {
    ...
    ProductListComponent.prototype.transfer = function ($event, row, cell) {
        ...
        if (cell.header === 'Action') {
            ...
            row.showWeight = this.authService.isAuth(__WEBPACK_IMPORTED_MODULE_9__shared_Roles_enum__["a" /* Roles */].Grower);
            row.showVolume = this.authService.isAuth(__WEBPACK_IMPORTED_MODULE_9__shared_Roles_enum__["a" /* Roles */].Winery) && row.wineries && row.wineries.length;
            ...
            dialogRef.afterClosed().subscribe(function (result) {
                if (result) {
                    ...
                    _this.dataSource = new __WEBPACK_IMPORTED_MODULE_1__angular_material__["v" /* MatTableDataSource */](_this.records);
                    _this.service.transportProduct(row.id, result)
                        .subscribe(function (res) { return res; });
                }
            });
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1__angular_material__["n" /* MatPaginator */]),
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1__angular_material__["t" /* MatSort */]),
...
var HyperledgerService = /** @class */ (function () {
    ...
    HyperledgerService.prototype.getAllProducts = function (history) {
        switch (this.authService.currentRole) {
            ...
            case __WEBPACK_IMPORTED_MODULE_9__shared_Roles_enum__["a" /* Roles */].Logistic2:
                if (history) {
                    return this.http.get(this.baseUrl + "/api/transports2", { params: { history: history } })
                        .map(function (res) {
                        var result = [];
                        res.json().forEach(function (product) {
                            product.transports.forEach(function (transport) {
    ...
    HyperledgerService.prototype.transportProduct = function (productId, transferDate) {
        var transfer = { productId: productId, transferDate: transferDate };
        switch (this.authService.currentRole) {
            case __WEBPACK_IMPORTED_MODULE_9__shared_Roles_enum__["a" /* Roles */].Grower:
...
(function (Roles) {
    ...
    Roles[Roles["Logistic"] = 2] = "Logistic";
    Roles[Roles["Winery"] = 3] = "Winery";
    Roles[Roles["Logistic2"] = 4] = "Logistic2";
    Roles[Roles["Bottler"] = 5] = "Bottler";
    Roles[Roles["Warehouse"] = 6] = "Warehouse";
})(Roles || (Roles = {}));


/***/ }),

/***/ "./src/app/shared/app.validators.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var AppValidators = /** @class */ (function () {
    ...
    AppValidators.alphaHyphenSpaceApos = function (control) {
        return testControlWithRegex(/^[ A-Za-z-']*$/, control, 'alphaHyphenSpaceApos');
    };
    AppValidators.numberSpace = function (control) {
...
function testControlWithRegex(regex, control, errorLabel) {
...
module.exports = "<form [formGroup]=\"form\" (ngSubmit)=\"onSubmit(form.value)\">\r\n  <div class=\"example-container\">\r\n    <div class=\"row\">\r\n      <div class=\"col-6\">\r\n        <mat-grid-list cols=\"1\" rowHeight=\"70px\" gutterSize=\"20px\">\r\n          <mat-grid-tile>\r\n            <mat-form-field>\r\n              <mat-label>Actual Weight(T)</mat-label>\r\n              <input matInput placeholder=\"Actual Weight(T)\" formControlName=\"actualWeight\">\r\n              <mat-error *ngIf=\"form.get('actualWeight').hasError('required')\">{{getErrorMessage()}}</mat-error>\r\n              <mat-error *ngIf=\"form.get('actualWeight').hasError('float')\">Number with 2 decimals</mat-error>\r\n                </mat-form-field>\r\n          </mat-grid-tile>\r\n          <mat-grid-tile>\r\n            <mat-form-field>\r\n              <mat-label>Volume(L)</mat-label>\r\n              <input matInput placeholder=\"Volume\" formControlName=\"volume\">\r\n              <mat-error *ngIf=\"form.get('volume').hasError('required')\">{{getErrorMessage()}}</mat-error>\r\n              <mat-error *ngIf=\"form.get('volume').hasError('numberSpace')\">Please entre a number</mat-error>\r\n            </mat-form-field>\r\n          </mat-grid-tile>\r\n          <mat-grid-tile>\r\n            <mat-form-field>\r\n              <mat-label>\r\n                <mat-icon>domain</mat-icon>\r\n                <i> Status </i>\r\n              </mat-label>\r\n              <mat-select formControlName=\"status\" required>\r\n                <mat-option>-- None --</mat-option>\r\n                <mat-option *ngFor=\"let status of statuses\" [value]=\"status\">{{ status }}</mat-option>\r\n              </mat-select>\r\n              <mat-error *ngIf=\"form.get('status').hasError('required')\">{{getErrorMessage()}}</mat-error>\r\n            </mat-form-field>\r\n          </mat-grid-tile>\r\n            </mat-grid-list>\r\n      </div>\r\n      <div class=\"col\" *ngIf=\"showCard()\">\r\n        <div class=\"card\" style=\"width: 20rem;\">\r\n          <div class=\"card-body\">\r\n            <h5 class=\"card-title\">Product information</h5>\r\n            <ul class=\"list-group list-group-flush\">\r\n              <li class=\"list-group-item\">\r\n                <div class=\"row\">\r\n                  <div class=\"col\">Compnay:</div>\r\n                  <div class=\"col\">{{ product.companyName }}</div>\r\n                </div>\r\n              </li>\r\n              <li class=\"list-group-item\">\r\n                <div class=\"row\">\r\n                  <div class=\"col\">Variety:</div>\r\n                  <div class=\"col\">{{ grape.variety }}</div>\r\n                </div>\r\n              </li>\r\n              <li class=\"list-group-item\">\r\n                <div class=\"row\">\r\n                  <div class=\"col\">Vintage:</div>\r\n                  <div class=\"col\">{{ grape.vintage }}</div>\r\n                </div>\r\n              </li>\r\n              <li class=\"list-group-item\">\r\n                <div class=\"row\">\r\n                  <div class=\"col\">Weight:</div>\r\n                  <div class=\"col\">{{ grape.estimatedWeight }}</div>\r\n                </div>\r\n              </li>\r\n            </ul>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n\r\n  </div>\r\n  <div class=\"button-row\">\r\n    <button mat-raised-button color=\"primary\" type=\"submit\">Submit</button>\r\n    <button mat-raised-button color=\"warn\" [routerLink]=\"['/home/products','winery']\">Cancel</button>\r\n  </div>\r\n</form>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_auth_service__ = __webpack_require__("./src/app/services/auth.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__common_no_auth_error__ = __webpack_require__("./src/app/common/no-auth-error.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_app_validators__ = __webpack_require__("./src/app/shared/app.validators.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WineryProductComponent = /** @class */ (function () {
    function WineryProductComponent(service, router, route, authService, fb) {
        ...
        this.statuses = ['Grapes', 'Juice', 'Grape Must', 'Unfinished Wine', 'Bottle Ready Wine'];
    ...
    WineryProductComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.form = this.fb.group({
            actualWeight: [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_7__shared_app_validators__["a" /* AppValidators */].float]],
            volume: [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_7__shared_app_validators__["a" /* AppValidators */].numberSpace]],
            status: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required],
        });
        this.route.params.subscribe(function (pamams) {
            _this.service.getProduct(pamams.id)
