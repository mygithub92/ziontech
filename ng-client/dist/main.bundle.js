...
var BottlerProductComponent = /** @class */ (function () {
    ...
    BottlerProductComponent.prototype.ngOnInit = function () {
        ...
        this.form = this.fb.group({
            brand: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            lcode: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            label: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            corkCap: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            status: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            boxes: [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__shared_app_validators__["a" /* AppValidators */].numberSpace]]
        });
        this.form.controls.status.valueChanges
            .takeUntil(this.unsubscribe)
            .subscribe(function (newValue) {
            if (newValue === 'Bulk Wine') {
                _this.form.controls.boxes.clearValidators();
            }
            else {
                _this.form.controls.boxes.setValidators([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required, , __WEBPACK_IMPORTED_MODULE_8__shared_app_validators__["a" /* AppValidators */].numberSpace]);
            }
        });
...
var AddProductComponent = /** @class */ (function () {
    ...
    AddProductComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.form = this.fb.group({
            companyName: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            region: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            vineyard: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            block: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            rowRange: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            variety: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            vintage: [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_10__shared_app_validators__["a" /* AppValidators */].numberSpace]],
            bins: [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_10__shared_app_validators__["a" /* AppValidators */].numberSpace]],
            status: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            estimatedWeight: [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_10__shared_app_validators__["a" /* AppValidators */].float]]
        });
...
var ConfirmDialogComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ConfirmDialogComponent.prototype, "remainingBoxNumber", {
        get: function () {
    ...
    ConfirmDialogComponent.prototype.showBoxNumber = function () {
    ...
    Object.defineProperty(ConfirmDialogComponent.prototype, "minDate", {
        get: function () {
            return new Date();
        },
        enumerable: true,
...
var ProductListComponent = /** @class */ (function () {
    ...
    ProductListComponent.prototype.populateGrowerMetaData = function () {
        this.columns = [
            ...
            { columnDef: 'bins', header: 'Numbers of Bins', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'bins'); } },
    ...
    ProductListComponent.prototype.populateWarehouseMetaData = function () {
        this.columns = [
            ...
            { columnDef: 'vintage', header: 'Vintage', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].grapeValue(row, 'vintage'); } },
            { columnDef: 'brand', header: 'Brand', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].wineValue(row, 'brand'); } },
            { columnDef: 'boxes', header: 'Number of box', cell: function (row) { return "" + __WEBPACK_IMPORTED_MODULE_5__model_Product__["a" /* Product */].wineValue(row, 'boxes'); } },
        ];
    };
...
(function (Roles) {
    ...
    Roles[Roles["Logistic2"] = 5] = "Logistic2";
...
var WineryProductComponent = /** @class */ (function () {
    function WineryProductComponent(service, router, route, authService, fb) {
        ...
        this.statuses = ['Grape', 'Juice', 'Grape Must', 'Unfinished Wine', 'Bottle Ready Wine'];
    ...
    WineryProductComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.form = this.fb.group({
            actualWeight: [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_7__shared_app_validators__["a" /* AppValidators */].float]],
            volume: [null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_7__shared_app_validators__["a" /* AppValidators */].numberSpace]],
            status: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
        });
        this.route.params.subscribe(function (pamams) {
            _this.service.getProduct(pamams.id)
